...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>{{__('messages.Update')}} "{{$role->name}}"</h1>
                </div>
                <div class="col-sm-6">
    ...
    <form id="form" method="POST" action="{{ route('role.update', $role->id) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" required name="name"
                                        value="{{ $role->name }}" placeholder="{{__('messages.Enter Name')}}">
                                    @error('name')
